<?php
/**
 * ACF Support Post Relation Processor - Processes post relations.
 *
...
/**
 * Processes ACF post relations.
 *
 * @since 0.10.0
 */
class PostRelationProcessor {
	/**
	 * Logger instance.
	 *
	...
	/**
	 * Process post_object/relationship relation.
	 *
	 * @since 0.10.0
	 *
	 ...
	 * @return void
	 */
	public function process_post_relation( \WP_Post $target_post, string $meta_key, array $field ): void {
