...
interface TranslatorInterface {
         ...
         * @return float
         */
        public function estimate_cost( string $text ): float;
}
 ...
 * @since 0.2.0
 */
abstract class BaseProvider implements TranslatorInterface {
	use ContainerAwareTrait;
         ...
         * @return string
         */
        protected function apply_glossary_pre( string $text, string $source, string $target, string $domain ): string {
                /**
         ...
         * @return string
         */
        protected function apply_glossary_post( string $text, string $source, string $target, string $domain ): string {
                /**
         ...
         * @return array<string>
         */
        protected function chunk_text( string $text, int $limit ): array {
         ...
         * @return array<string>
         */
        protected function split_long_text( string $text, int $limit ): array {
                $segments = array();
         ...
         * @return string
         */
        abstract protected function get_rate_option_key(): string;
