...
class FPML_Simple_Settings {
	...
	protected function handle_save() {
		...
		// Log per debugging
		error_log( 'FPML Simple Settings: Save result: ' . ( $result ? 'SUCCESS' : 'FAILED' ) );
		error_log( 'FPML Simple Settings: Data count: ' . count( $sanitized_data ) );
