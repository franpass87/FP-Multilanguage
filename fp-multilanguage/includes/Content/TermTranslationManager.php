...
class TermTranslationManager {
        ...
        public function handle_term_delete( int $term_id, int $tt_id, string $taxonomy, $deleted_term = null, $object_ids = array() ): void {
        ...
        public function expose_translations( $response, $term, $request ) {
                unset( $request );
